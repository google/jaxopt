...
from jaxopt import implicit_diff2 as implicit_diff
...
# ridge_objective(params, hyperparams, data)
...
def main(argv):
  ...
  # Run outer loop.
  for _ in range(50):
    theta, state = solver.update(params=theta, state=state, data=(data, init_w))
