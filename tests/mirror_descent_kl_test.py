...
from jaxopt import mirror_descent_kl
...
class MirrorDescentKLTest(jtu.JaxTestCase):
  ...
  def test_multiclass_svm_dual(self):
    ...
    solver_fun = mirror_descent_kl.make_solver_fun(
        fun=fun,
        init=beta_init,
    ...
    beta_fit2 = mirror_descent_kl.mirror_descent_kl_update(
        beta_fit, jax.grad(fun)(beta_fit, lam))
